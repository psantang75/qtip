...
import { QuizBuilder, type QuizBuilderData, type QuizBuilderErrors } from '@/components/training/QuizBuilder'
import { validateQuizBuilder } from '@/components/training/quizBuilderValidation'
