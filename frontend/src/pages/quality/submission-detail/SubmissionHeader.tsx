import { ArrowLeft, AlertTriangle, CheckCircle, Edit3, Bot, Unlock, RotateCcw } from 'lucide-react'
        ...
        <span className="text-[15px] font-semibold text-slate-900 truncate flex items-center gap-2">
          ...
          {(detail.reopen_count ?? 0) > 0 && (
            <span
              ...
              title="An administrator has reopened this review after it was scored. See Admin -> Unlock Register for the reasons."
            >
              <RotateCcw className="h-3 w-3" />
              Reopened {detail.reopen_count}&times;
            </span>
          )}
        </span>
